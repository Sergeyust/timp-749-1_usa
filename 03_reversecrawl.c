...
int find_mo_out(tree* t, int value)
{
    if (t->value == value)
    {
        printf("_ ");
        ...
        if (value < t->value)
        {
            if (t->left != NULL)
            {
                if (t->left->value == value)
                {
                    ...
                    return (find_mo_out(t->left, value));
            }
            else
                return 1;
        }
        else
        {
            if (t->right != NULL)
            {
                if (t->right->value == value)
                {
                    ...
                    return (find_mo_out(t->right, value));
            }
            else
                return 1;
        }
...
//obhod
void reverse_tree_traversal(tree* t)
{
    if (t == NULL)
        return;
    reverse_tree_traversal(t->left);
    reverse_tree_traversal(t->right);
    printf("%d ", t->value);
}
